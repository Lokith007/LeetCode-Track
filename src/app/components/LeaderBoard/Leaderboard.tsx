          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative group">
                ...
                <div 
                  className={`absolute top-full left-0 mt-2 w-full bg-[#0f0f0f] border border-[#f59e0b40] rounded-xl shadow-xl transition-all duration-200 z-10 ${
                ...
                >
                  {[
                    ...
                    <button
                      ...
                      className={`w-full px-4 py-3 text-left text-sm font-medium transition-all duration-200 hover:bg-[#1a1a1a] first:rounded-t-xl last:rounded-b-xl ${
                        filter === option.value
                ...
                <div className="flex bg-[#0f0f0f] border border-[#f59e0b40] rounded-xl p-1 shadow-lg">
                  {[
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 flex items-center gap-2 hover:scale-105 hover:shadow-lg ${
                        contestTab === tab.value
        ...
        <div className="mt-4 mb-8 flex justify-center">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-3 py-1.5 border border-[#f59e0b40] rounded-md text-gray-200 hover:bg-[#f59e0b20] hover:border-[#f59e0b40] disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:border-[#f59e0b40] transition-all duration-200 flex items-center gap-2 text-sm font-medium"
            >
            ...
            <div className="flex gap-2">
              {(() => {
                ...
                return pages.map((p, idx) =>
                  p === "..." ? (
                    <span key={idx} className="px-2 py-1.5 text-gray-400 flex items-center text-sm">
                      ⋯
                    </span>
                  ) : (
                    <button
                      ...
                      className={`px-3 py-1.5 border rounded-md transition-all duration-200 min-w-[2.5rem] text-sm font-medium ${
                        pageIndex === p 
                          ? "bg-[#f59e0b] text-black border-[#f59e0b] font-semibold shadow-lg" 
                          : "bg-[#0f0f0f] text-gray-200 border-[#f59e0b40] hover:bg-[#f59e0b20] hover:border-[#f59e0b40]"
                      }`}
                    >
                      {(p as number) + 1}
                    </button>
